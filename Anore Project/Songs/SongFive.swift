...
class SongFive: AllSongs {
    ...
    private func createCharts() {
        ...
        //4
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 0, octave: 4), pitch: "C", distance: 0, isHit: false), duration: crochet))
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 0, octave: 4), pitch: "C", distance: 0, isHit: false), duration: crochet))
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 2, octave: 4), pitch: "D", distance: 0, isHit: false), duration: crochet))
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 4, octave: 4), pitch: "E", distance: 0, isHit: false), duration: crochet))
        //5
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 4, octave: 4), pitch: "E", distance: 0, isHit: false), duration: crochet*1.5))
        ...
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 4, octave: 4), pitch: "E", distance: 0, isHit: false), duration: crochet))
        //9
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 2, octave: 4), pitch: "D", distance: 0, isHit: false), duration: crochet*1.5))
        ...
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 2, octave: 4), pitch: "D", distance: 0, isHit: false), duration: crochet))
        //SOLLL
        notes.append(NoteView(note: Note(octave: 2, frequency: freq(index: 7, octave: 3), pitch: "G", distance: 0, isHit: false), duration: crochet*2))
        //14
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 4, octave: 4), pitch: "E", distance: 0, isHit: false), duration: crochet))
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 4, octave: 4), pitch: "E", distance: 0, isHit: false), duration: crochet))
        notes.append(NoteView(note: Note(octave: 3, frequency: freq(index: 5, octave: 4), pitch: "F", distance: 0, isHit: false), duration: crochet))
